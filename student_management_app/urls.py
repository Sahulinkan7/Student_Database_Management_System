...
urlpatterns = [
    ...
    path("add_exam/",adminviews.addnewExam,name="add_exam"),
    ...
    path("create_exam/",adminviews.create_examination,name="create_exam"),
    path("add_result/",staff_views.add_result,name="add_result"),
    path("get_students_for_exam/",staff_views.get_students_for_exam,name="get_students_for_exam"),
    path("get_subjects_for_exam/",staff_views.get_subjects_for_exam,name="get_subjects_for_exam"),
    path("student_view_result",student_views.exam_result,name="student_exam_result"),
